...
// Tally block shared by the office master sheets (Stock Item Name starts
// at AC in American Standards, AK in Absolute Enterprises). Prefix
// columns to the left of that are internal/SAP and are not exported.

...
— data model, every feature, the full API surface, roles, deployment, and a
frank list of what's not production-ready yet.
...
| `ops/` | Backup/restore scripts, Caddy TLS reverse-proxy config — see `ops/README.md` |
